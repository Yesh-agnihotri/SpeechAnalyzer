...
// options specified by gso.
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        ...
        Bitmap icon = BitmapFactory.decodeResource(getActivity().getResources(),R.drawable.user_default);
        imgProfilePic.setImageBitmap(ImageHelper.getRoundedCornerBitmap(getActivity(),icon, 200, 200, 200, false, false, false, false));
